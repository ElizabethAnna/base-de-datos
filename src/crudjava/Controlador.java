...
public class Controlador implements ActionListener, MouseListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == v.btnAgregar) {
            ...
            p.setPrecio(Integer.parseInt(v.spPrecio.getValue().toString()));
            p.setCantidad(Integer.parseInt(v.spCantidad.getValue().toString()));
        ...
        if (ae.getSource() == v.btnGuardar) {
            ...
            p1.setPrecio(Integer.parseInt(v.spPrecio.getValue().toString()));
            p1.setCantidad(Integer.parseInt(v.spCantidad.getValue().toString()));
